package com.thecodemonkey.buildinggadgets.common.util.ref;

import com.thecodemonkey.buildinggadgets.BuildingGadgets;
import net.minecraft.util.Identifier;

public class NBTKeys {
    public static final Identifier AND_SERIALIZER_ID = new Identifier(BuildingGadgets.MOD_ID, "sub_entries");
    ...
    public static final Identifier OR_SERIALIZER_ID = new Identifier(BuildingGadgets.MOD_ID, "alternatives");
    public static final Identifier SIMPLE_SERIALIZER_ID = new Identifier(BuildingGadgets.MOD_ID, "entries");
    private NBTKeys() {}
